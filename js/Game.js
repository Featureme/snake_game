...
Game.prototype.start = function(){
	...
	this.timer = setInterval(function(){
		//更新、显示帧编号
		self.frame ++;
		var meter=parseInt(self.frame/50/60);
		var scode=parseInt(self.frame/50%60);
		meter=meter>10?meter:'0'+meter;
		scode=scode>10?scode:'0'+scode;
		// infoBox.innerHTML = self.frame;
		infoBox.innerHTML = meter+':'+scode;
		//每10帧更新蛇、渲染蛇
		if(self.frame % 10 == 0){
			//先更新蛇，然后渲染蛇
